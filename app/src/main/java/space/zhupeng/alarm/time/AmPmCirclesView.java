...
public class AmPmCirclesView extends View {
    ...
    private float mAmPmCircleRadiusMultiplier = 0.22f;
    ...
    public void initialize(Context context, TimePickerController controller, int amOrPm) {
        ...
        mAmPmTextColor = ContextCompat.getColor(context, R.color.time_text_color);
        mAmPmDisabledTextColor = ContextCompat.getColor(context, R.color.text_disabled);
        mSelectedAlpha = SELECTED_ALPHA;

        mSelectedColor = controller.getAccentColor();
        mTouchedColor = Utils.darkenColor(mSelectedColor);
        mAmPmSelectedTextColor = ContextCompat.getColor(context, android.R.color.white);
